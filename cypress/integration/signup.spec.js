...
describe('Signup', () => {
    ...
    it('User Should Be Deliver', function () {
        ...
        signup.modalContentShouldBe(expectedMsg)
    })
    ...
    it('Incorrect Document', function () {
        ...
        signup.fillForm(deliver)
        signup.submit()
        const expectedMsg = 'Oops! CPF inválido'
        signup.alertMessageShouldBe(expectedMsg)
    ...
    it('Incorrect Email', function () {
        ...
        signup.fillForm(deliver)
        signup.submit()
        const expectedMsg = 'Oops! Email com formato inválido.'
        signup.alertMessageShouldBe(expectedMsg)
